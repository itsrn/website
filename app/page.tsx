  ...
  return (
    <>
      <main className="relative flex min-h-screen flex-col items-center md:p-20 p-10">
        ...
        <div className="flex w-2/3 text-white flex-col text-3xl items-start gap-x-8 gap-y-8 bg-[#131315] px-12 py-10 rounded-3xl max-mdd:max-w-none max-md:p-8">
